  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        <div className="mb-6">
          <label htmlFor="hub-search" className="sr-only">Search subchats</label>
          <input
            id="hub-search"
            type="search"
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            placeholder="Search subchats by title…"
        ...
        <h2 className="text-lg font-semibold text-stone-900 mb-4">Subchats</h2>
          ...
          <ul className="flex flex-col gap-2">
            {hubChats.map((ch) => {
              ...
              const created = ch.created_at
                ...
                : null;
              return (
                <li key={ch.id} className="rounded-xl border border-stone-200 bg-white shadow-sm overflow-hidden">
                  <button
                    type="button"
