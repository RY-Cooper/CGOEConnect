...
export const usersAPI = {
  ...
  suspend:    (id)          => req('PATCH',  `/users/${id}/suspend`),
  unsuspend:  (id)          => req('PATCH',  `/users/${id}/unsuspend`),
  ban:        (id)          => req('PATCH',  `/users/${id}/ban`),
  unban:      (id)          => req('PATCH',  `/users/${id}/unban`),
...
export const postsAPI = {
  ...
  pin:     (id)          => req('PATCH',  `/posts/${id}/pin`),
  vote:    (id, optionId) => req('POST',  `/posts/${id}/vote`, { optionId }),
